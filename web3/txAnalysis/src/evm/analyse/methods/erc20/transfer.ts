...
const transfer = (trace) => {
  try {
    ...
    if (decodedByInputData.functionName !== erc20Info.functionNameMap.transfer) {
      return null
    }
    const [decodedByInputDataRecipient, decodedByInputDataValue] = decodedByInputData.args
