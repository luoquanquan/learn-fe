...
const increaseAllowance = (trace) => {
  try {
    ...
    const selectorMatched = selector === erc20Info.functionSelector.increaseAllowance
    ...
    if (decodedByInputData.functionName !== erc20Info.functionNameMap.increaseAllowance) {
      return null
    }
