  ...
  return (
    <main className="min-h-screen bg-slate-950 px-6 py-12 text-slate-100 md:px-10">
      <div className="mx-auto max-w-4xl rounded-3xl border border-white/10 bg-slate-900/70 p-8 shadow-2xl shadow-indigo-900/20 backdrop-blur md:p-10">
        <h1 className="text-2xl font-bold tracking-tight md:text-3xl">Encrypt Demo</h1>
        <p className="mt-2 text-sm text-slate-300">Encrypt Page 请打开控制台查看效果</p>
        {errorMessage ? (
        ...
        <div className="mt-8 grid gap-6">
          ...
          <div className="grid gap-4 pt-2 md:grid-cols-2">
            <div className="rounded-xl border border-white/10 bg-slate-800/60 p-4">
              <p className="text-xs font-medium uppercase tracking-wide text-slate-400">加密结果</p>
            ...
            <div className="rounded-xl border border-white/10 bg-slate-800/60 p-4">
              <p className="text-xs font-medium uppercase tracking-wide text-slate-400">解密结果</p>
              <p className="mt-2 break-all text-sm text-slate-200">
